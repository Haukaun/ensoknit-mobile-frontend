import { YarnDetailsModal } from '@/features/yarn/components/YarnDetailsModal';
import { YarnFormModal } from '@/features/yarn/components/YarnFormModal';
import { YarnGrid } from '@/features/yarn/components/YarnGrid';
...
export function YarnTabContent() {
  ...
  return (
    <View className="flex-1">
      <YarnGrid onYarnPress={handleYarnPress} onAddYarn={() => setShowCreateModal(true)} />

      {/* FAB - Floating Action Button */}
      <Pressable
        className="absolute bottom-4 right-4 h-14 w-14 items-center justify-center rounded-full bg-primary shadow-lg active:opacity-80"
